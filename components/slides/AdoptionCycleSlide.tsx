            ...
            >
              <defs>
                ...
                <linearGradient id="highlightGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <stop offset="100%" stopColor="rgba(26, 114, 133, 0.6)" />
                </linearGradient>
                {/* Gradient for non-highlighted segments */}
                <linearGradient id="normalGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="rgba(26, 114, 133, 0.5)" />
                  <stop offset="100%" stopColor="rgba(26, 114, 133, 0.2)" />
                </linearGradient>
              </defs>
              ...
              {/* Baseline */}
              <line x1="20" y1="260" x2="480" y2="260" stroke="rgba(0, 0, 0, 0.2)" strokeWidth="2" />
              ...
              {segments.map((segment, i) => {
                ...
                return (
                  <text
                    ...
                    y={labelYPositions[i]}
                    textAnchor="middle"
                    className="text-[11px] sm:text-[13px] font-semibold fill-gray-600"
                  >
                    {segment.label}
                  </text>
                );
                ...
                return (
                  <text
                    ...
                    className={`text-[10px] sm:text-[12px] font-medium ${
                      isHighlighted ? 'fill-[#1A7285]' : 'fill-gray-500'
                    }`}
                  >
                    {segment.percentage}
                  </text>
                ...
                return (
                  <g>
                    ...
                    <text
                      ...
                      y={markerY - 85}
                      textAnchor="middle"
                      className="text-[11px] font-bold fill-[#1A7285]"
                    >
                      Early Adopters
                    </text>
                    <text
