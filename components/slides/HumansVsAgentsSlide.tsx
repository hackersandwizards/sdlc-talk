        ...
        <div className="flex flex-1 items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-8">
          <div className="w-full max-w-5xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 md:gap-10">
              {/* Automated Column */}
              <div className="p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-[#1A7285]/20 bg-gradient-to-br from-[#1A7285]/5 to-white">
                <div className="flex items-center gap-3 mb-4 sm:mb-5 md:mb-6">
                  <Bot className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#1A7285]" />
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#1A7285] uppercase tracking-wider">
                    Agents Replace
                  </h2>
                </div>
                    ...
                    return (
                      <div
                        ...
                        className={cn(
                          ...
                          isVisible ? "bg-gray-100" : "bg-gray-50 opacity-20"
                        )}
                      >
                        <div className={cn(
                          "w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors duration-300",
                          isVisible ? "bg-[#1A7285]" : "bg-gray-300"
                        )} />
                        <span className={cn(
              ...
              {/* Boosted Column */}
              <div className="p-4 sm:p-5 md:p-6 rounded-xl sm:rounded-2xl border border-[#9333EA]/20 bg-gradient-to-br from-[#9333EA]/5 to-white">
                <div className="flex items-center gap-3 mb-4 sm:mb-5 md:mb-6">
                  <User className="w-6 h-6 sm:w-7 sm:h-7 md:w-8 md:h-8 text-[#9333EA]" />
                  <h2 className="text-lg sm:text-xl md:text-2xl font-semibold text-[#9333EA] uppercase tracking-wider">
                    Humans Boosted
                  </h2>
                </div>
                <div className="space-y-2 sm:space-y-3">
                  {slide.boosted.map((item, index) => {
                    ...
                    return (
                      ...
                      >
                        <div className={cn(
                          "w-1.5 h-1.5 sm:w-2 sm:h-2 rounded-full transition-colors duration-300",
                          isVisible ? "bg-[#9333EA]" : "bg-gray-300"
                        )} />
                        <span className={cn(
                          "text-sm sm:text-base md:text-lg transition-colors duration-300",
                          isVisible ? "text-gray-700" : "text-[#9CA3AF]"
