...
export function WrongReactionSlide({ slide }: Props) {
  ...
  const colorClass = isFading ? 'rgba(147, 51, 234, 0.12)' : 'rgba(26, 114, 133, 0.15)';
        ...
        <div className="pt-6 sm:pt-8 md:pt-12 text-center px-4">
          <BlurFade delay={0.1} duration={0.6}>
            <h1 className={cn(
              ...
              isFading ? "text-[#9333EA]" : "text-[#1A7285]"
            )}>
              {slide.headline}
            </h1>
          </BlurFade>
              ...
              return (
                <div
                  ...
                  className={cn(
                    ...
                    isFading
                      ? "border-[#9333EA]/20 bg-[#9333EA]/5"
                      : "border-[#1A7285]/20 bg-[#1A7285]/5",
