            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6">
              {slide.quotes.map((quote, index) => (
                <BlurFade key={index} delay={0.2 + index * 0.15} duration={0.5}>
                  <div className="flex flex-col rounded-xl sm:rounded-2xl border border-gray-200 bg-white overflow-hidden h-full">
                    {/* Image */}
                    ...
                    <div className="p-3 sm:p-4 md:p-5 flex-1 flex flex-col">
                      <p className="text-sm sm:text-base md:text-lg text-gray-700 italic flex-1">
