    ...
    <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 sm:gap-8 md:gap-10">
        ...
        <div className="relative flex-shrink-0">
          {profile.imageSrc ? (
            <img
              ...
              alt={profile.name}
              className="h-32 w-32 sm:h-40 sm:w-40 md:h-48 md:w-48 lg:h-56 lg:w-56 rounded-full border-4 border-[#1A7285]/20 object-cover"
            />
          ) : (
            <div className="flex h-32 w-32 sm:h-40 sm:w-40 md:h-48 md:w-48 lg:h-56 lg:w-56 items-center justify-center rounded-full border-4 border-[#1A7285]/20 bg-gradient-to-br from-[#1A7285]/5 to-white">
              <User className="h-16 w-16 sm:h-20 sm:w-20 md:h-24 md:w-24 lg:h-28 lg:w-28 text-[#1A7285]/40" />
            </div>
          )}
        </div>
      </BlurFade>
      ...
      <BlurFade delay={0.25} duration={0.5}>
        <div className="flex flex-col justify-center text-center sm:text-left sm:pt-4">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#212121]">
            {profile.name}
          </h2>
          <p className="mt-2 sm:mt-3 text-lg sm:text-xl md:text-2xl font-medium text-[#1A7285]">
            {profile.title}
          </p>
          {profile.linkedIn && (
            <a
              ...
              className="mt-4 sm:mt-6 inline-flex items-center justify-center sm:justify-start gap-2 sm:gap-3 text-base sm:text-lg md:text-xl text-[#1A7285] transition-colors hover:text-[#1A7285]/80"
            >
