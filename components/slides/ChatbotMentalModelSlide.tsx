        ...
        <div className="flex flex-1 flex-col items-center justify-center px-4 sm:px-8 md:px-12 lg:px-16 py-4 sm:py-6 md:py-8">
          ...
          <BlurFade delay={0.2} duration={0.5}>
            <div className="mb-8 sm:mb-12 md:mb-16 text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-light text-[#6B7280] italic">
                ...
                return (
                  <div key={index} className="flex items-center gap-2 sm:gap-3 md:gap-4">
                    <div className="flex flex-col items-center gap-2">
                      <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 rounded-full bg-gray-100 border border-gray-200">
                        <Icon className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-[#6B7280]" />
                      </div>
                      <span className="text-xs sm:text-sm md:text-base text-[#6B7280] font-medium">
                        {step}
                      </span>
                    </div>
                    {index < slide.steps.length - 1 && (
                      <div className="hidden sm:block w-8 md:w-12 lg:w-16 h-0.5 bg-gray-200" />
                    )}
                  </div>
                );
              })}
          ...
          <BlurFade delay={0.6} duration={0.5}>
            <p className="mt-8 sm:mt-12 md:mt-16 text-lg sm:text-xl md:text-2xl text-[#9CA3AF]">
              {slide.tagline}
            </p>
          </BlurFade>
        </div>
