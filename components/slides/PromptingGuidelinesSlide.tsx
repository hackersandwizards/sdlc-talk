            ...
            {slide.guidelines.map((guideline, index) => {
              ...
              return (
                <div
                  key={index}
                  className={cn(
                    'rounded-2xl border bg-gradient-to-br from-[#1A7285]/5 to-white px-6 py-5 md:px-8 md:py-6 transition-all duration-500',
                    isVisible
                      ? 'border-[#1A7285]/20 opacity-100 translate-y-0'
                      : 'border-transparent opacity-0 translate-y-4 pointer-events-none'
                  )}
                >
                  <div className="flex items-center gap-4 md:gap-5 mb-4">
                    <div className="flex-shrink-0 flex items-center justify-center w-10 h-10 md:w-12 md:h-12 rounded-full bg-[#1A7285]/10 text-[#1A7285] font-bold text-xl md:text-2xl">
                      {index + 1}
                    </div>
                    <h2 className="text-lg md:text-2xl lg:text-3xl font-semibold text-[#212121]">
                      {guideline.title}
                    </h2>
                  </div>
                  <div className="flex flex-col gap-2 pl-14 md:pl-17">
                    <div className="rounded-lg bg-red-50 border border-red-500/20 px-4 py-2 font-mono text-sm md:text-base">
                    ...
                    <div className="rounded-lg bg-emerald-50 border border-emerald-500/20 px-4 py-2 font-mono text-sm md:text-base">
