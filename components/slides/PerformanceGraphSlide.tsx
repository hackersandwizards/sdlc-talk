          ...
          <BlurFade delay={0.3} duration={0.6}>
            <div className="relative" style={{ width: '80vw', maxWidth: '1100px', height: '60vh', maxHeight: '600px' }}>
              ...
              <div className="absolute -left-4 top-1/2 -translate-y-1/2">
                <span
                  className="text-sm sm:text-base md:text-lg text-[#6B7280] font-medium whitespace-nowrap block"
              ...
              <div className="relative w-full h-full ml-8">
                ...
                <div className="absolute left-0 right-0 bottom-0 h-0.5 bg-gray-400" />
                ...
                >
                  ...
                  <defs>
                    <linearGradient id="curveGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                      <stop offset="0%" stopColor="rgba(26, 114, 133, 1)" />
                      <stop offset="40%" stopColor="rgba(26, 114, 133, 0.8)" />
                      <stop offset="100%" stopColor="rgba(147, 51, 234, 1)" />
                    </linearGradient>
                    <linearGradient id="areaGradient" x1="0%" y1="0%" x2="0%" y2="100%">
                      <stop offset="0%" stopColor="rgba(26, 114, 133, 0.3)" />
                      <stop offset="100%" stopColor="rgba(26, 114, 133, 0.02)" />
                    </linearGradient>
                  </defs>
                ...
                >
                  ...
                  <div className="relative">
                    ...
                    <div className="relative w-5 h-5 sm:w-6 sm:h-6 rounded-full bg-green-500 border-2 border-gray-100 shadow-lg shadow-green-500/50" />
                  </div>

                  {/* Label */}
                  <div className="absolute left-8 sm:left-10 top-1/2 -translate-y-1/2 whitespace-nowrap">
                    <div className="px-4 py-2 rounded-xl bg-[#1A7285]/10 border border-[#1A7285]/30 backdrop-blur-sm">
                      <span className="text-sm sm:text-base md:text-lg font-bold text-[#1A7285]">
                        {slide.currentMarker}
                      </span>
                    </div>
                  </div>
                ...
                <div
                  ...
                  style={{ right: '8%', top: '8%' }}
                >
                  <div className="px-4 py-3 rounded-xl bg-[#9333EA]/10 border border-[#9333EA]/30 backdrop-blur-sm">
                    <span className="text-sm sm:text-base md:text-lg font-semibold text-[#9333EA]">
                      {slide.futureNote}
                    </span>
                  </div>
                </div>
                ...
                <div className="absolute -bottom-10 left-1/2 -translate-x-1/2">
                  <span className="text-sm sm:text-base md:text-lg text-[#6B7280] font-medium">
                    {slide.xLabel}
                  </span>
                </div>
              </div>
