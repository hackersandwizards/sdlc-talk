...
import { ProcessStepSlide } from '@/components/slides/ProcessStepSlide';
import { ReviewSlide } from '@/components/slides/ReviewSlide';
import { MemeSlide } from '@/components/slides/MemeSlide';
...
import { sdlc } from '@/data/presentations/sdlc';
...
export default async function SlidePage({ params }: Props) {
  ...
  return (
    <SlideContainer>
      ...
      {slide.type === 'process-step' && <ProcessStepSlide slide={slide} />}
      {slide.type === 'review' && <ReviewSlide slide={slide} />}
      {slide.type === 'meme' && <MemeSlide slide={slide} />}
